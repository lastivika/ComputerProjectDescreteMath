...
# Перевірка двох графів на ізоморфізм (Використаний алгоритм Вайсфайлера–Лемана)
  ### Чому алгоритм Вейсфейлера-Лемага?
...
2. Реалізований алгоритм Вайсфайлера–Лемана.
   ...
   ### В коді реалізовано:
- Функція пошуку діаметра.
- Запуск циклу довжиною k(чим більше k - тим більш точніший алгоритм).
- Створення словників "міток".
- Порівнянння міток.
  
# Висновки
  У цьому проєкті ми розробили бібліотеку для роботи з графами та реалізували основні алгоритми, які часто використовують у практичних задачах. У процесі роботи ми краще зрозуміли, як будуються та працюють різні представлення графів, і як саме реалізуються алгоритми пошуку, перевірки властивостей та знаходження циклів.
